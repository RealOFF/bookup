...
var require_GorhomPortal = __commonJS({
  "../../node_modules/@tamagui/portal/dist/cjs/GorhomPortal.js"(exports2, module2) {
    ...
    var PortalHostComponent = /* @__PURE__ */ __name(({ name }) => {
      const isServer = (0, import_core.useIsSSR)();
      ...
      return GroupFrame.extractable(
        (0, import_react.forwardRef)((propsIn, ref) => {
          const {
            ...
            borderRadius,
            ...props
          } = (0, import_core.getExpandedShorthands)(propsIn);
          const radius = borderRadius ?? (sizeProp ? (0, import_core.getVariableValue)((0, import_core.getTokens)().radius[sizeProp]) - 1 : void 0);
  ...
  "../../node_modules/tamagui/dist/cjs/views/LinearGradient.js"(exports2, module2) {
    ...
    var useLinearGradientColors = /* @__PURE__ */ __name((colors) => {
      ...
      return colors.map((color) => {
        if (color[0] === "$") {
          return (0, import_core.variableToString)(theme[color] || color);
        }
        return color;
      });
...
var require_MyComponent = __commonJS({
  "../../packages/ui/dist/cjs/MyComponent.js"(exports2, module2) {
    ...
    var import_tamagui = require_cjs40();
