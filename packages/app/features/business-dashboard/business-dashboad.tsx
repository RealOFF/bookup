import { Button, ButtonProps, H3, Paragraph, XStack, YStack, H4 } from '@bookup/uikit'
import { Tag, Gift, Users, PieChart, UserPlus, Send } from '@tamagui/feather-icons'
import { useLink } from 'solito/link'

const StyledButton = (props: ButtonProps) => <Button
  {...props}
  h='$7'
  w='33.3%'
  fd='column'
    ...
    <YStack w='100%' ai="center">
      <YStack px='$3' jc='space-between' w='100%' maw={600}>
        ...
        <YStack mt='$12' p='$6' bg='$gray3' br='$5'>
          <H4>
            Everything for your business processes
          </H4>
          <Paragraph>
